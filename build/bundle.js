...
var UserList_1 = __webpack_require__(115);
var ChatWindow_1 = __webpack_require__(114);
var MessageApp = (function (_super) {
    ...
    function MessageApp() {
        ...
        _this.getMe = function () { return _this.getUsers().filter(function (user) { return user.id === 1; })[0]; };
        _this.getWith = function () { return _this.getUsers().filter(function (user) { return user.id === 10; })[0]; };
        return _this;
    }
    MessageApp.prototype.render = function () {
        return (React.createElement("div", { className: "App" },
            React.createElement("div", { className: "App-header" },
                React.createElement("h2", null, "Welcome to React")),
            React.createElement(UserList_1.default, { users: this.getUsers() }),
            React.createElement(ChatWindow_1.default, { me: this.getMe(), with: this.getWith(), messages: this.getMessages() })));
    };
    return MessageApp;
}(React.Component));
...
var ChatHeader = function (_super) {
    ...
    ChatHeader.prototype.render = function () {
        return React.createElement(
            ...
            React.createElement("img", { src: this.props.avatar, className: "avatar", alt: this.props.userName }),
            React.createElement(
                "div",
                { className: "chatAbout" },
                React.createElement(
    ...
    ChatMessage.prototype.render = function () {
        return React.createElement(
            ...
            React.createElement(
                "div",
                { className: "" },
                this.props.message.timeSpan.format('YYYY-MM-DD hh:mm:ss')
            )
        );
    };
    return ChatMessage;
...
var React = __webpack_require__(1);
var ChatHeader_1 = __webpack_require__(112);
var ChatMessage_1 = __webpack_require__(113);
var ChatWindow = function (_super) {
    ...
    ChatWindow.prototype.render = function () {
        ...
        return React.createElement(
            'div',
            { className: 'chat' },
            React.createElement(ChatHeader_1.default, _extends({ key: this.props.with.id }, this.props.with)),
            this.props.messages.sort(function (a, b) {
                return ChatWindow.orderBy(a, b);
            }).map(function (m) {
                var chatMessageProp = _this.toChatMessageProps(m);
                return React.createElement(ChatMessage_1.ChatMessage, _extends({ key: chatMessageProp.message.id }, chatMessageProp));
            })
        );
    };
    return ChatWindow;
...
var React = __webpack_require__(1);
var UserListView_1 = __webpack_require__(116);
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                this.props.users.map(function (user) {
                    return React.createElement(UserListView_1.default, _extends({ key: user.id }, user));
                })
            )
        );
    };
...
var UserListView = function (_super) {
    ...
    UserListView.prototype.render = function () {
        ...
        return React.createElement(
            'li',
            null,
            React.createElement('img', { src: props.avatar, className: 'avatar', alt: props.userName }),
            React.createElement(
                'div',
                { className: 'about' },
                React.createElement(
                ...
                React.createElement(
                    'div',
                    { className: 'status' },
                    React.createElement('i', { className: statusTag }),
...
var MessageApp_1 = __webpack_require__(110);
ReactDOM.render(React.createElement(MessageApp_1.default, null), document.getElementById('root'));
